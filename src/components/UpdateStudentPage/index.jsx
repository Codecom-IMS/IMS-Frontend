...
import { BlueButton, HeaderChip, InputField, MainBox, StudentForm } from "../index"
...
const UpdateStudentPage = () => {
    ...
    const onSubmit = async () => {
        try {
            ...
            (studentData?.body.gender === "male")? setUserGenderRadioChecked(true) : setUserGenderRadioChecked(false);
        } catch (error) {
            console.log(error)
        }
    }
    return (
        <MainBox>
            ...
            {(!studentFound) ? <><div className="search-field">
                ...
                <StudentForm buttonTitle={"Update"} apiUrl={updateApiUrl} callMethod="PUT" 
