...
import { HeaderChip, MainBox, InputField,BlueButton,RedButton, Toast } from "../index"
...
const DeleteTeacherPage = () => {
    ...
    return (
        <MainBox>
            ...
            {teacherFound ? <><div className="delete-page-fields">
                <InputField inputType={"number"} label={"Teacher ID:"} value={teacher?.body.id} editable={true} />
                <InputField inputType={"text"} label={"Teacher Name:"} value={teacher?.body.name} editable={true} />
                <InputField inputType={"text"} label={"Email:"} value={teacher?.body.email} editable={true} />
            </div>
                <RedButton buttonText={"Delete"} onSubmitHandler={deleteTeacher} />
            </> : <><div className="search-field">
                <InputField inputType={"number"} label={"Teacher ID:"} placeholder={"Enter ID"} value={teacherId} onChangeFunction={onChangeTeacherId} />
