...
import { MainBox, HeaderChip, InputField, BlueButton, RedButton, Toast } from "../index";
...
const DeleteStudentPage = () => {
    ...
    return (
        <MainBox>
            ...
            {studentFound ? <><div className="delete-page-fields">
                <InputField inputType={"number"} label={"Roll Number:"} value={student?.body.roll_number} editable={true} />
                <InputField inputType={"text"} label={"Student Name:"} value={student?.body.student_name} editable={true} />
                <InputField inputType={"text"} label={"Father Name:"} value={student?.body.father_name} editable={true} />
            </div>
            <RedButton buttonText={"Delete"} onSubmitHandler={deleteStudent}/>
            </> : <><div className="search-field">
                <InputField inputType={"number"} label={"Roll Number:"} placeholder={"Enter Roll Number"} value={rollNumber} onChangeFunction={onChangeRollNumber} />
            </div><BlueButton buttonText={"Search"} onSubmitHandler={onSubmit} /></>}
            <Toast/>
        </MainBox>
    )
}
