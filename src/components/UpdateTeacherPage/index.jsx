...
const UpadteTeacherPage = ()=>{
    ...
    return (
        <MainBox>
            ...
            {teacherFound? teacherData.body?<TeacherForm apiUrl={api} callMethod={"PUT"} defaultTeacherName={teacherData?.body.name} defaultTeacherEmail={teacherData?.body.email} defaultTeacherPassword={teacherData?.body.password}/>:<div>Teacher not exists</div>:<>
